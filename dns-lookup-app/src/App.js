            ...
            <table>
              ...
              <tbody>
                {groupedRecords[type].map((record, index) => (
                  <tr key={index}>
                    <td data-label="Type"><FaGlobe /> {record.type}</td>
                    <td data-label="Name">{record.name}</td>
                    <td data-label="TTL" title={`${record.TTL} seconds`}>{formatTTL(record.TTL)}</td>
                    <td data-label="Data" className="data-cell">{formatDnsData(record)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
